...
namespace StudentsEvents.Library.DbAccess
{
    public class SqlDataAccess : ISqlDataAccess
    {
        ...
        public async Task<IEnumerable<T>> LoadDataAsync<T, U>(string storedProcedure, U parameters, string connectionId = "StudentsEventsDataDb")
        {
        ...
        public async Task SaveDataAsync<T>(string storedProcedire, T parameters, string connectionId = "StudentsEventsDataDb")
        {
            using IDbConnection connection = new SqlConnection(_config.GetConnectionString(connectionId));
